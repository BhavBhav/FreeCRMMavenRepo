...
public class TestBase {
	...
	public TestBase(){
		try {
			...
			prop = new Properties();
			FileInputStream file = new FileInputStream("C:\\Users\\Lucky\\eclipse-workspace\\CRMMaven\\src\\main\\java\\com\\crm\\qa\\cofigProperties\\config.Properties");
			prop.load(file);
		}
	...
	public static void initialize(){
		...
		if(browserName.equalsIgnoreCase("chrome")) {
			System.setProperty("webdriver.chrome.driver",""
					+ "C:\\Users\\Lucky\\Desktop\\java and Selenium\\ChromeDriverVersion\\V80\\chromedriver.exe");
		...
		driver.get(prop.getProperty("urlGenHealthy"));
